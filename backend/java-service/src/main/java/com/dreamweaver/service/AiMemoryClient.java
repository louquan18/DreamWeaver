...
public class AiMemoryClient {
    ...
    public AiMemoryExtractionResponse extractMemoryChanges(
        UUID storyId,
        UUID chapterId,
        AiMemoryExtractionRequest request
    ) {
        try {
            AiMemoryExtractionResponse response = restClient.post()
                .uri(
                    "/internal/ai/stories/{storyId}/chapters/{chapterId}/memory-changes/extract",
                    storyId,
                    chapterId
                )
                .body(request)
                .retrieve()
                .body(AiMemoryExtractionResponse.class);
